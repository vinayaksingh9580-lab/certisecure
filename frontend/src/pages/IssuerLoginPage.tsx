...
export default function IssuerLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (tokenResponse.user.role !== 'issuer') {
        logout();
        setError('Unauthorized: Not an issuer account.');
        setLoading(false);
        return;
      }
      localStorage.setItem('user_type', 'issuer');
      navigate('/dashboard');
    } catch (err: any) {
    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white">Issuer Sign In</h1>
          <p className="text-gray-400 text-sm mt-1">Access the Institution Dashboard</p>
        </div>
        ...
        <div className="glass-panel p-8 rounded-2xl border border-gray-800 shadow-2xl">
          ...
          <div className="mt-8 pt-6 border-t border-gray-800">
            ...
            <div className="space-y-2 text-xs">
              ...
              >
                <span><strong>Issuer:</strong> issuer@sms.edu.in</span>
