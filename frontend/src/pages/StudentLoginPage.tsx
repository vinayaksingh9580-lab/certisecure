...
export default function StudentLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      navigate('/student/certificates'); // Students go to their certificates
    } catch (err: any) {
    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-sm mt-1">Access your Digital Certificates</p>
        </div>
        ...
        <div className="glass-panel p-8 rounded-2xl border border-gray-800 shadow-2xl">
          ...
          <div className="mt-8 pt-6 border-t border-gray-800">
            ...
            <div className="mt-4 text-center">
              <Link to="/student/register" className="text-sm text-emerald-400 hover:text-emerald-300">
